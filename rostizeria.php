...
<head>
	...
	<title>Rosticeria</title>
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="css/estilos.css">	
	<script src="js/metodos.js"></script>
</head>
<body>
<h3 style="font-family:ALEGRIAN; text-align:center;">ROSTICERIA</h3>
	<div class="container">
		<div class="row">	
...
<?php
			...
			$consulta= "SELECT * FROM rosticeria";
			if ($resultado = $mysqli->query($consulta)) 
			{
				...
				{					
					...
					echo "<a class='btn btn-danger' href='elimina4.php?codigo=" .$fila[0] ."'><span class='glyphicon glyphicon-trash'></span></a>";		
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="insertar4.php" method="GET">              		
