...
<head>
	...
	<title>Bebidas y Licores</title>
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="css/estilos.css">	
	<script src="js/metodos.js"></script>
</head>
<body style="background:pink">
<h3 style="font-family:ALEGRIAN; text-align:center;">BEBIDAS Y LICORES</h3>
	<div class="container">
		<div class="row">	
...
<?php
			...
			$consulta= "SELECT * FROM bebidaslic";
			if ($resultado = $mysqli->query($consulta)) 
			{
				...
				{					
					...
					echo "<a class='btn btn-danger' href='elimina3.php?codigo=" .$fila[0] ."'><span class='glyphicon glyphicon-trash'></span></a>";		
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="insertar3.php" method="GET">              		
        ...
        <div class="modal" id="editProd" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="actualiza3.php" method="POST">                       		
