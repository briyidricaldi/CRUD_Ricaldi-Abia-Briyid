...
<h3 style="font-family:ALEGRIAN; text-align:center;">ABARROTES</h3>
	<div class="container">
		<div class="row">	
...
<?php
			...
			$consulta= "SELECT * FROM abarrotes";
			if ($resultado = $mysqli->query($consulta)) 
			{
				...
				{					
					...
					echo "<a class='btn btn-danger' href='elimina2.php?codigo=" .$fila[0] ."'><span class='glyphicon glyphicon-trash'></span></a>";		
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
