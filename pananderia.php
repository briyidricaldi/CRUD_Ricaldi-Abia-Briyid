...
<body>
<h3 style="font-family:ALEGRIAN; text-align:center;">PANADERIA</h3>
	<div class="container">
		<div class="row">	
...
<?php
			...
			$consulta= "SELECT * FROM panaderia";
			if ($resultado = $mysqli->query($consulta)) 
			{
				...
				{					
					...
					echo "<a class='btn btn-danger' href='elimina8.php?codigo=" .$fila[0] ."'><span class='glyphicon glyphicon-trash'></span></a>";		
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form action="insertar8.php" method="GET">              		
        ...
        <div class="modal" id="editProd" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="actualiza8.php" method="POST">                       		
