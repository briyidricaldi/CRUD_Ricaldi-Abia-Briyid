...
<body>
<h3 style="font-family:ALEGRIAN; text-align:center;">LIBRERIA</h3>
	<div class="container">
		<div class="row">	
			...
			<table class="table table-hover" style="background-color: rgba(0,0,0,0.2);">
				<tr>
...
<?php
			...
			if ($resultado = $mysqli->query($consulta)) 
			{
				...
				{					
					...
					echo "<a class='btn btn-danger' href='elimina.php?codigo=" .$fila[0] ."'><span class='glyphicon glyphicon-trash'></span></a>";		
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
